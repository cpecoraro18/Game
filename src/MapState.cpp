...
bool MapState::Init() {
	...
	LevelButton* testLevelButton = new LevelButton(data, 3 * SCREEN_WIDTH / 6, 2.5 * SCREEN_HEIGHT / 3, 32, 32, 32, 32, "TestLevel");
	testLevelButton->loadtexture("location", 0, 0);
	levels.push_back(testLevelButton);
